...
class Organization {
    ...
    bool is_sponsoring(const std::string& n) const;

    std::vector<Event> attending_events(const std::string& n) const;
    std::vector<std::string> get_attendee_list(const std::string& n) const; 
